...
파트너는 AEP(Adobe [!DNL Experience Platform])을 통해 수신 및 송신 기능을 빌드하도록 지원하기 위해 이 통합 가이드를 사용해야 합니다. 일괄 처리 수집, 스트리밍 수집 및 통합 프로필 액세스(이그레스)를 위한 API가 있습니다.
